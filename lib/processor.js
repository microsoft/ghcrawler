...
class Processor {
  ...
  traffic(request) {
    request.addRootSelfLink();
    request.queueRoot('referrers', `${request.url}/traffic/popular/referrers`);
    request.queueRoot('paths', `${request.url}/traffic/popular/paths`);
    request.queueRoot('views', `${request.url}/traffic/views`);
    request.queueRoot('clones', `${request.url}/traffic/clones`);
    return request.document;
  }
