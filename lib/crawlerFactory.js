...
const ElasticsearchStore = require('../providers/storage/elasticsearchstore');
...
class CrawlerFactory {
  ...
  static createStore(options) {
    ...
    switch (options.provider) {
      ...
      case 'elastic': {
        store = CrawlerFactory.createElasticsearchStore(options);
        break;
      }
      case 'mongo': {
  ...
  static createElasticsearchStore(options) {
    return new ElasticsearchStore(config.get('CRAWLER_ELASTICSEARCH_URL'), options);
  }
  ...
  static createDeadletterStore(options) {
    ...
    switch (options.provider) {
      ...
      case 'elastic': {
        return CrawlerFactory.createElasticsearchStore(options);
      }
      case 'mongo': {
